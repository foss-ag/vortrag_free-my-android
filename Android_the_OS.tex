...
\begin{frame}{Struktur der Software}
	\begin{itemize}[<+->]
		...
		\begin{itemize}[<+->]
			...
			\item Data
			\note{ Benutzerdatenpartition; Hier werden Kontakte, Nachrichten, Dauerhafte Appdaten und mehr gelagert }
			\item SDCard / ExtSDCard
			\note{ Zusätzlicher Speicher der dem Nutzer frei zur Verfügung steht. Hier werden heruntergeladene Dateien, Musik, Bilder und Videos und weiteres gespeichert. }
			\item Cache
			\note{ Partition zum Speichern temporärer Daten. Kann bedenkenlos geleert werden. }
		\end{itemize}
